...
public class CustomerController {
	...
	public ModelAndView cusInfoDetail(Model model, HttpServletRequest request, HttpSession session)
	{
		String customerName = request.getParameter("j_username");
		Customer customer = customerService.findById(Integer.parseInt(customerName));
